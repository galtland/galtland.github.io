...
confidence: medium
summary: "Allen Farrington's 2021 essay reads Bitcoin as a civilizational exit from fiat finance, using Venice, medieval commerce, Islamic finance, mobile capital, open-source money, and programmable settlement as interpretive frames."
short: "Farrington's 2021 essay: Bitcoin as civilizational exit from fiat finance, framed through Venice, mobile capital, Islamic finance, and programmable money."
---
...
That distinction links the essay to [[lightning-network|Lightning Network]] and [[the-lightning-network-paper|The Lightning Network Paper]]: programmable settlement and routed payments matter because they extend sound bearer money rather than replacing it with centrally managed credit.

## See Also

- [[cypherpunk|Cypherpunk]] - topic map placing Farrington in the modern synthesis layer
- [[bitcoin-whitepaper|Bitcoin Whitepaper]] - base technical artifact behind Farrington's interpretation
- [[the-bitcoin-standard|The Bitcoin Standard]] - Austrian-Bitcoin synthesis adjacent to Farrington's monetary argument
- [[the-fiat-standard|The Fiat Standard]] - fiat-system critique adjacent to the essay's capital-strip-mining frame
- [[fiat-as-engineered-system|Fiat as Engineered System]] - concept article for fiat as a designed debt architecture
- [[unforgeable-costliness|Unforgeable Costliness]] - monetary primitive behind Bitcoin's hard-money interpretation
- [[lightning-network|Lightning Network]] - second-layer payment infrastructure Farrington treats as part of Bitcoin's financial expansion
- [[speculative-attack|Speculative Attack]] - another modern hyperbitcoinization-oriented synthesis essay

## Sources

- [Bitcoin Is Venice](https://allenfarrington.medium.com/bitcoin-is-venice-8414dda42070) - primary 2021 Medium essay as archived in raw
