...
This book is a primary feeder into [[state-power-and-intervention|State Power and Intervention]]. It also helps explain why [[libertarianism|Libertarianism]] in the present source set is not merely skeptical of big government, but hostile to the state as a standing legal exception.
...
- [[murray-n-rothbard|Murray N. Rothbard]] - author node for Rothbard's wider economic and political corpus
- [[state-power-and-intervention|State Power and Intervention]] - main compiled concept article built around the anti-state thesis
