...
>
> — [[julian-assange|Julian Assange]], "State and Terrorist Conspiracies"
...
>
> — [[julian-assange|Julian Assange]], *Cypherpunks: Freedom and the Future of the Internet*
...
The book calls itself "a watchman’s shout in the night", and its program is stated in one line: "Our task is to secure self-determination where we can, to hold back the coming dystopia where we cannot, and if all else fails, to accelerate its self-destruction." Eight months after publication, the [[snowden-disclosures|Snowden disclosures]] moved the warning from cypherpunk prediction to documented public record.
...
The contested ground is real and this wiki's framing is honestly partisan. Critics — including, from common knowledge outside the cited raws, WikiLeaks' onetime media partners — have charged that its publishing choices endangered named sources; the harm-versus-transparency question remains genuinely disputed, and the raws here (Assange's own texts plus a sympathetic academic study) cannot settle it, though the book's footnotes do invite readers to inspect the other side of the ledger by "comparing redacted versions of cables with full versions, in order to see what WikiLeaks' media partners redacted". The wiki reads Assange through the censorship-resistance lens — the mirroring and the blockade as the empirical demonstration that chokepoints, not statutes, are where publishing actually stops — and notes that [[farewell-to-westphalia|Farewell to Westphalia]], the corpus's bridge from cypherpunk foundations to post-state governance, is dedicated to him.

## See Also

- [[of-cypherpunks-and-sousveillance|Of Cypherpunks and Sousveillance]] - the academic frame for WikiLeaks as mature cypherpunk sousveillance
- [[timothy-c-may|Timothy C. May]] - the first-generation counterpoint: May's market conception of transparency against Assange's justice-oriented one
- [[crypto-anarchy|Crypto Anarchy]] - the thesis Assange inherited and re-aimed from private markets to institutional transparency
- [[censorship-resistance|Censorship Resistance]] - the property the mass-mirroring and the banking blockade made a live political question
- [[snowden-disclosures|The Snowden Disclosures]] - June 2013: the book's warning confirmed by the state's own documents
- [[farewell-to-westphalia|Farewell to Westphalia]] - the 2025 post-state governance book dedicated to Assange

## Sources

- [State and Terrorist Conspiracies / Conspiracy as Governance (Assange, 2006)](https://cryptome.org/0002/ja-conspiracies.pdf) - the 2006 iq.org essays: conspiracies as information networks, leaks as a secrecy tax
- [Cypherpunks: Freedom and the Future of the Internet (Full Text Aggregate)](https://archive.org/details/CypherpunksFreedomAndTheFutureOfTheInternet_201708) - the 2012 book: "A Call to Cryptographic Arms", the persecution note, the banking blockade, and the Bitcoin discussion
- [Of Cypherpunks and Sousveillance](https://www.cypherpunkbooks.com/book/of-cypherpunks-and-sousveillance) - Anderson (2022) on Assange as third-generation cypherpunk and WikiLeaks as data activism (OCR source; quotes hand-checked)
