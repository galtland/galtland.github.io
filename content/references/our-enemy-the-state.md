...
Nock explicitly follows [[oppenheimer-the-state|The State]] and its [[political-means-and-economic-means|Political Means and Economic Means]] distinction. [[anatomy-of-the-state|Anatomy of the State]] later cites Nock for the state-power/social-power contrast, making Nock one of the transmission links into Rothbardian libertarianism.

The supplied raw extraction contains six chapters, not five. This reference follows the actual extracted text.

## See Also

- [[albert-jay-nock|Albert Jay Nock]] - author reference
- [[franz-oppenheimer|Franz Oppenheimer]] - upstream sociological source
...
- [Our Enemy, the State](https://famguardian.org/Publications/OurEnemyTheState/OurEnemyTheState-byAlbertJKnock.pdf) - full-text PDF extraction aggregate with six chapters and chapter footnotes
