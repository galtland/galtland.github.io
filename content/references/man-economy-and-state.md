...
This source gives the libertarian topic wiki a full-scale treatise rather than a manifesto or polemic alone. It shows that [[murray-n-rothbard|Murray N. Rothbard]] is not only the author of anti-state slogans in this corpus. He is also the economist providing the analytic machinery for exchange, calculation, and intervention that later books rely on more briefly.

## Provenance and Compile Value

The current raw source was re-extracted on 2026-06-17 from the official Mises Institute EPUB (clean XHTML), superseding the earlier pdftotext extraction that carried OCR-style artifacts; it retains the *Man, Economy, and State* portion of the combined Scholar's-Edition EPUB while keeping the *Power and Market* appendix in its own raw. That provenance matters for the wiki because later compile passes can cite and synthesize the full work directly. It is also the reason this book now carries more evidentiary weight than a normal one-page library ingest.
...
- [[credit-and-deferred-payment|Credit and Deferred Payment]] - draws the present-good-for-future-good definition and the cash-vs-credit transaction-completion diagnostic from this book (Ch. 2 §11, Ch. 6 §2, Ch. 11)
...
- [[hundred-percent-reserve-banking|100% Reserve Banking]] - Rothbardian normative position that demand deposits and bank-issued notes must be 100% covered by money proper held in reserve
...
- [[the-mystery-of-banking|The Mystery of Banking]] - Rothbard's 1983 (2nd ed 2008) book-length popular treatment of money, banking, central banking, and the 100%-reserve case
