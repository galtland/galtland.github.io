...
> A user-proposed two-sentence characterization is tested against the wiki's compiled corpus. The first sentence — the State as parasite that conceals itself as symbiosis — is the dominant anarcho-libertarian position in the current corpus ([[murray-n-rothbard|Rothbard]], [[franz-oppenheimer|Oppenheimer]], [[albert-jay-nock|Nock]], Bastiat, [[lysander-spooner|Spooner]], La Boetie, [[hans-hermann-hoppe|Hoppe]]), with non-libertarian convergence from [[charles-tilly|Tilly]]'s historical sociology and Nietzsche's philosophical witness. Within the contemporary scope, the thesis is scope-limited only by the classical-liberal partition ([[ludwig-von-mises|Mises]], [[friedrich-a-hayek|Hayek]]), which reserves a legitimate minimal-protective state. Nock's distinction between *government* and *the State* does NOT supply a second carve-out for modern regimes — he treats modern state-scale political institutions as States, and reserves "government" for pre-State societies where economic exploitation was impracticable. The second sentence — that dictatorship and organized crime are less-skilled versions of the same parasite — is supported for ordinary regimes by Tilly's protection-racket essay and the bandit-to-King line from Rothbard, but breaks at totalitarianism in [[hannah-arendt|Arendt]]'s specific sense: the parasite frame presupposes sustainable extraction from a still-functioning host, and totalitarian rule aims instead at total domination.
...
**Minarchist disagreement.** [[liberalism|Mises's Liberalism]] (1927) and [[road-to-serfdom|Hayek's The Road to Serfdom]] (1944) treat a minimal protective state as legitimate, not parasitic — the parasite framing applies to interventionism, not to a strictly limited night-watchman state. [[libertarianism|Libertarianism]] explicitly flags the minarchist-vs-anarchist split. Sentence 1 in the user's framing is the anarcho-capitalist position; classical liberals would partition the state into legitimate-protective and parasitic-interventionist rather than treat the whole as a single parasite.
