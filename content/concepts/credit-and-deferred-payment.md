...
This is also why Mises insists on treating the entire universe of deferred payments together. Monetary changes that alter the value of money do not just hit explicit loans; they hit every contract in which delivery and payment are separated in time. In [[human-action|Human Action]] Ch. XX (p. 537), he stresses that over all species of deferred payments hangs, like a sword of Damocles, the danger of money’s value being altered. The species he is talking about run from formal bonds down to ordinary trade obligations.
