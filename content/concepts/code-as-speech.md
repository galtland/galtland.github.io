...
confidence: high
summary: "Code as speech is the Crypto Wars legal thesis that encryption source code can be protected First Amendment expression because programmers use code to communicate precise algorithmic ideas. Bernstein v. United States applied that thesis against export-control licensing of cryptography as unconstitutional prior restraint."
...
The Ninth Circuit opinion explains source code as text written in a high-level programming language. A computer cannot directly run source code until it is compiled into object code, and programmers can read source code to understand the method it expresses. That dual character is the center of the case.
...
The concept should stay bounded. Bernstein did not hold that every software object is fully protected speech in every regulatory context. The opinion emphasized encryption source code in source form, the record of expressive use among cryptographers, and a licensing system that directly burdened publication.
...
- [[bernstein-v-united-states-1999|Bernstein v. United States (1999)]] - Ninth Circuit opinion applying the code-as-speech thesis to encryption export controls
